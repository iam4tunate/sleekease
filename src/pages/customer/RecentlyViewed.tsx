...
export default function RecentlyViewed() {
  ...
  console.log(viewedItems.length);
  return (
    <div>
      ...
      {!viewedItems || !viewedItems.length ? (
        <div className='flex flex-col items-center justify-center text-center py-8'>
          ...
          <p className='padX w-[60%] max-sm:w-[90%] pt-3 text-base max-sm:text-sm leading-[1.3]'>
            You haven't viewed any products recently. Start exploring our
            collection to see your recent views here!
          </p>
        </div>
      ) : (
            ...
            <div className='flex items-start gap-x-2 border rounded-md py-2.5 pl-2 pr-4'>
              ...
              <div className='flex flex-col justify-between w-full h-full'>
                ...
                <div className='flex items-center justify-between'>
                  <p className='font-rubikMedium opacity-90'>₦{item.price}</p>
