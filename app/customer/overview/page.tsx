    ...
    <div>
      ...
      <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-6 px-4 max-sm:px-2'>
        <div className='border rounded-md'>
          <p className='border-b px-4 max-sm:px-2 py-4 pb-2 uppercase font-poppinsMedium'>
            Account Details
          </p>
          <div className='px-4 max-sm:px-2 py-4'>
            <UserCircle size={35} />
            <p className='font-poppinsMedium text-gray-600 capitalize pt-3 pb-1'>
              Joseph Ogodu
            </p>
        ...
        <div className='padX grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-x-8 gap-y-6'>
          {AccountStats.map((stat) => (
            <div
              ...
              <p className='border-b px-4 max-sm:px-2 py-3 w-full uppercase font-poppinsMedium'>
                {stat.name}
              </p>
              <div className='px-4 max-sm:px-2 py-4 flex items-center justify-between w-full'>
                <p className='font-poppinsSemibold text-3xl max-sm:text-2xl'>
                  {stat.value}
                </p>
